...
<section class="container-fluid d-flex justify-content-center">
    <form action="{{route('students.store')}}" method="post" class="mt-4">
        ...
        <div class="form-floating">
            <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="num_list">
        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-6 mt-4">
              <input type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline" name="surname">
            </div>
        </div>
        ...
        <div class="form-floating mt-4">
            <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="degrees_id">
